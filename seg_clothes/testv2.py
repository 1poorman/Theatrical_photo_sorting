...
# ========== 5. 保存结果 ==========
cv2.imwrite("../output/seg_clothes/image-2/output_overlay.jpg", overlay)

# （可选）单独保存纯分割图
cv2.imwrite("../output/seg_clothes/image-2/seg_color.png", color_seg)
...
cv2.imwrite("../output/seg_clothes/image-2/output_overlay_selected_classes.jpg", overlay_selected)
