...
from embedding.image_search_system_module import ImageEmbedder, VectorDatabase
...
def main():
    ...
    index_dir = "embedding/index/test_siglip2_index"
    ...
    from embedding.image_search_system_module import ImageSearcher
